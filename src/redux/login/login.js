...
export const login = authorizationCode => {
    return dispatch => {
        return SpotifyClient.postAuthenticate(authorizationCode).then(accessTokenResponse => {
            dispatch({
                type: LOG_IN_SUCCESS,
...
export const checkLogin = () => {
    return dispatch => {
        return SpotifyClient.getAccessTokenLifetime().then(accessTokenResponse => {
...
export const refreshAccessToken = () => {
    return dispatch => {
        return SpotifyClient.postAccessTokenRefresh().then(accessTokenResponse => {
            dispatch({
