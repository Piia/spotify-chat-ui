...
import { addMessage, getChatHistory, getChatters, addChatter, removeChatter } from 'redux/chat/chat';
...
const withChatClient = WrappedComponent => {
    ...
    const mapStateToProps = state => ({
        ...
        userId: state.profile && state.profile.profileData && state.profile.profileData.id
    });
